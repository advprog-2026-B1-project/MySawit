...
class DeliveryControllerTest {
    ...
    void createDelivery_shouldReturnCreated() {
        ...
        ResponseEntity<DeliveryResponse> response = deliveryController.createDelivery(1L, request);
    ...
    void updateStatus_shouldReturnOk() {
        ...
        ResponseEntity<DeliveryResponse> response = deliveryController.updateStatus(1L, 2L, request);
    ...
    void decideByMandor_shouldReturnOk() {
        ...
        ResponseEntity<DeliveryResponse> response = deliveryController.decideByMandor(2L, 1L, request);
    ...
    void getDeliveriesByDriver_shouldReturnOk() {
        when(deliveryService.getByDriver(1L)).thenReturn(List.of(dummyResponse));

        ResponseEntity<List<DeliveryResponse>> response = deliveryController.getDeliveriesByDriver(1L);

        assertEquals(HttpStatus.OK, response.getStatusCode());
        verify(deliveryService).getByDriver(1L);
    }
    ...
    void getDeliveriesByMandor_shouldReturnOk() {
        ...
        ResponseEntity<List<DeliveryResponse>> response = deliveryController.getDeliveriesByMandor(1L);
    ...
    void getMandorOngoingDeliveries_shouldReturnOk() {
        ...
        ResponseEntity<List<DeliveryResponse>> response = deliveryController.getMandorOngoingDeliveries(1L, 2L, date, "test");
    ...
    void getMandorHistoryDeliveries_shouldReturnOk() {
        ...
        ResponseEntity<List<DeliveryResponse>> response = deliveryController.getMandorHistoryDeliveries(1L, 2L, date, "test");
